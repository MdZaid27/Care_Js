...
export default function CentreOfExcellence() {
  return (
    <div className="container mx-auto px-4 py-12">
      <h2 className="text-center text-heading text-headingColor leading-heading tracking-heading pb-heading-pb">Centre of Excellence</h2>
            ...
            {[
              ...
              <li key={item}>
                <a href="#" className="text-black hover:none flex items-center">
                  ...
                  <span className="ml-2 main-text font-small">{item}</span>
                </a>
              </li>
            ))}
          </ul>
